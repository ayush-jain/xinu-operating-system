...
extern	syscall myreceiven(umsg32* msgs, uint32 msg_count);
extern	uint32 myrecvtime(int32 maxwait, umsg32* msgs, uint32 msg_count);

/* in file mysend.c */
extern	syscall	mysend(pid32 pid, umsg32 msg);
extern	uint32	mysendn(pid32, umsg32* msgs, uint32 msg_count);
