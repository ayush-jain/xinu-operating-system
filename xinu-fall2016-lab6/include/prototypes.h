...
/* in file alarm_init.c */
void	alarm_init (void);
status	remove_alarm(int32, qid16);
status	insert_alarm(int32,	qid16,uint32);

/* in file alarm_register.c */
int32	alarm_register(int32, void (*)(int32), int32);
int32   alarm_deregister(int32 alarm_id);

/* in file alarm_trigger.c */
...
/* in file hpetcontrol.c */
devcall	hpetcontrol(struct dentry *, int32, int32, int32);

/* in file hpetdispatch.S */
void	hpetdispatch(void);

/* in file hpethandler.c */
void	hpethandler(void);

/* in file hpetinit.c */
devcall	hpetinit(struct dentry *);
